    ...
    <div className="page-anim">
      ...
      <div style={{background:'rgba(125,249,170,.04)',border:'2px solid rgba(125,249,170,.18)',borderRadius:13,padding:16,marginBottom:16}}>
        ...
        <div style={{fontSize:12,color:'#8890b0',lineHeight:1.6,marginBottom:12}}>
          Each person gets the task of the person <strong style={{color:'#E8F0FF'}}>above them</strong>. Last person's task goes to the <strong style={{color:'#E8F0FF'}}>first person</strong>. Creates Week <strong style={{color:'#7DF9AA'}}>{week+1}</strong>.
        </div>
