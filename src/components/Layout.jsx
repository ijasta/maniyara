...
export default function Layout({ siteSettings, isTaskAssigner }) {
  ...
  return (
    <>
      {/* ── MOBILE TOPBAR ── */}
      <div style={{display:'flex',position:'fixed',top:0,left:0,right:0,zIndex:9999,height:54,padding:'0 14px',alignItems:'center',justifyContent:'space-between',gap:10,background:'#070810',borderBottom:'1px solid rgba(125,249,170,.09)',backdropFilter:'blur(14px)',WebkitBackdropFilter:'blur(14px)',transform:'translateZ(0)',WebkitTransform:'translateZ(0)'}}
        className="mob-bar">
